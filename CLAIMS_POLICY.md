...
DOI / PROVENANCE HONESTY: the archival DOI is minted by a human on deposit and is published here as the explicit sentinel 'PENDING-ZENODO-MINT' until then; no fabricated DOI is asserted. Cite the repository URL and version until the DOI is minted.
